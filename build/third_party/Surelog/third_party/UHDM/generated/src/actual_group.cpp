...
bool actual_groupGroupCompliant(const any* item) {
  ...
  if ((uhdmtype != uhdmarray_expr) &&
      ...
      (uhdmtype != uhdmclocking_io_decl) &&
      (uhdmtype != uhdmconstant) &&
      (uhdmtype != uhdmenum_const) &&
      ...
      (uhdmtype != uhdminterface_array) &&
      (uhdmtype != uhdminterface_inst) &&
      (uhdmtype != uhdmio_decl) &&
      ...
      (uhdmtype != uhdmtypespec_member) &&
      (uhdmtype != uhdmunion_var) &&
      (uhdmtype != uhdmunsupported_expr) &&
      (uhdmtype != uhdmvar_bit) &&
      (uhdmtype != uhdmvar_select) &&
      (uhdmtype != uhdmvariables)) {
    item->GetSerializer()->GetErrorHandler()(ErrorType::UHDM_WRONG_OBJECT_TYPE, "Internal Error: adding wrong object type (" + UhdmName(uhdmtype) + ") in a actual_group group!", item, nullptr);
    return false;
  }
  return true;
}
