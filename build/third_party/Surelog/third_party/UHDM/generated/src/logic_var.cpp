...
namespace UHDM {
const BaseClass* logic_var::GetByVpiName(std::string_view name) const {
  if (ranges_ != nullptr) {
...
std::tuple<const BaseClass*, UHDM_OBJECT_TYPE, const std::vector<const BaseClass*>*> logic_var::GetByVpiType(int32_t type) const {
  switch (type) {
...
logic_var::vpi_property_value_t logic_var::GetVpiPropertyValue(int32_t property) const {
  switch (property) {
...
void logic_var::DeepCopy(logic_var* clone, BaseClass* parent, CloneContext* context) const {
  [[maybe_unused]] ElaboratorContext* const elaboratorContext = clonecontext_cast<ElaboratorContext*>(context);
  elaboratorContext->m_elaborator.enterLogic_var(clone, nullptr);
  ...
  elaboratorContext->m_elaborator.leaveLogic_var(clone, nullptr);
}

logic_var* logic_var::DeepClone(BaseClass* parent, CloneContext* context) const {
  logic_var* const clone = context->m_serializer->MakeLogic_var();
...
int32_t logic_var::Compare(const BaseClass *other, CompareContext* context) const {
  int32_t r = 0;
