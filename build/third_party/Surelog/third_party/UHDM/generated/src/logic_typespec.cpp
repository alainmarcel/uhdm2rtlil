...
namespace UHDM {
const BaseClass* logic_typespec::GetByVpiName(std::string_view name) const {
...
std::tuple<const BaseClass*, UHDM_OBJECT_TYPE, const std::vector<const BaseClass*>*> logic_typespec::GetByVpiType(int32_t type) const {
  switch (type) {
...
logic_typespec::vpi_property_value_t logic_typespec::GetVpiPropertyValue(int32_t property) const {
  switch (property) {
...
void logic_typespec::DeepCopy(logic_typespec* clone, BaseClass* parent, CloneContext* context) const {
  [[maybe_unused]] ElaboratorContext* const elaboratorContext = clonecontext_cast<ElaboratorContext*>(context);
  elaboratorContext->m_elaborator.enterLogic_typespec(clone, nullptr);
  ...
  elaboratorContext->m_elaborator.leaveLogic_typespec(clone, nullptr);
}

logic_typespec* logic_typespec::DeepClone(BaseClass* parent, CloneContext* context) const {
  logic_typespec* const clone = context->m_serializer->MakeLogic_typespec();
...
int32_t logic_typespec::Compare(const BaseClass *other, CompareContext* context) const {
  int32_t r = 0;
