...
namespace UHDM {
const BaseClass* constr_if::GetByVpiName(std::string_view name) const {
...
std::tuple<const BaseClass*, UHDM_OBJECT_TYPE, const std::vector<const BaseClass*>*> constr_if::GetByVpiType(int32_t type) const {
  switch (type) {
...
constr_if::vpi_property_value_t constr_if::GetVpiPropertyValue(int32_t property) const {
  switch (property) {
...
void constr_if::DeepCopy(constr_if* clone, BaseClass* parent, CloneContext* context) const {
  [[maybe_unused]] ElaboratorContext* const elaboratorContext = clonecontext_cast<ElaboratorContext*>(context);
  elaboratorContext->m_elaborator.enterConstr_if(clone, nullptr);
  ...
  elaboratorContext->m_elaborator.leaveConstr_if(clone, nullptr);
}

constr_if* constr_if::DeepClone(BaseClass* parent, CloneContext* context) const {
  constr_if* const clone = context->m_serializer->MakeConstr_if();
...
int32_t constr_if::Compare(const BaseClass *other, CompareContext* context) const {
  int32_t r = 0;
