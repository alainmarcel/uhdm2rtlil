...
namespace UHDM {
const BaseClass* implication::GetByVpiName(std::string_view name) const {
...
std::tuple<const BaseClass*, UHDM_OBJECT_TYPE, const std::vector<const BaseClass*>*> implication::GetByVpiType(int32_t type) const {
  switch (type) {
...
implication::vpi_property_value_t implication::GetVpiPropertyValue(int32_t property) const {
  switch (property) {
...
void implication::DeepCopy(implication* clone, BaseClass* parent, CloneContext* context) const {
  [[maybe_unused]] ElaboratorContext* const elaboratorContext = clonecontext_cast<ElaboratorContext*>(context);
  elaboratorContext->m_elaborator.enterImplication(clone, nullptr);
  ...
  elaboratorContext->m_elaborator.leaveImplication(clone, nullptr);
}

implication* implication::DeepClone(BaseClass* parent, CloneContext* context) const {
  implication* const clone = context->m_serializer->MakeImplication();
...
int32_t implication::Compare(const BaseClass *other, CompareContext* context) const {
  int32_t r = 0;
