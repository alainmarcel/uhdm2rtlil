...
namespace UHDM {
const BaseClass* gen_for::GetByVpiName(std::string_view name) const {
...
std::tuple<const BaseClass*, UHDM_OBJECT_TYPE, const std::vector<const BaseClass*>*> gen_for::GetByVpiType(int32_t type) const {
  switch (type) {
...
gen_for::vpi_property_value_t gen_for::GetVpiPropertyValue(int32_t property) const {
  switch (property) {
...
void gen_for::DeepCopy(gen_for* clone, BaseClass* parent, CloneContext* context) const {
  [[maybe_unused]] ElaboratorContext* const elaboratorContext = clonecontext_cast<ElaboratorContext*>(context);
  elaboratorContext->m_elaborator.enterGen_for(clone, nullptr);
  ...
  elaboratorContext->m_elaborator.leaveGen_for(clone, nullptr);
}

gen_for* gen_for::DeepClone(BaseClass* parent, CloneContext* context) const {
  gen_for* const clone = context->m_serializer->MakeGen_for();
...
int32_t gen_for::Compare(const BaseClass *other, CompareContext* context) const {
  int32_t r = 0;
