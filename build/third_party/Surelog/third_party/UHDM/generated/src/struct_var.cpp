...
namespace UHDM {
const BaseClass* struct_var::GetByVpiName(std::string_view name) const {
...
std::tuple<const BaseClass*, UHDM_OBJECT_TYPE, const std::vector<const BaseClass*>*> struct_var::GetByVpiType(int32_t type) const {
  switch (type) {
...
struct_var::vpi_property_value_t struct_var::GetVpiPropertyValue(int32_t property) const {
  switch (property) {
...
void struct_var::DeepCopy(struct_var* clone, BaseClass* parent, CloneContext* context) const {
  [[maybe_unused]] ElaboratorContext* const elaboratorContext = clonecontext_cast<ElaboratorContext*>(context);
  elaboratorContext->m_elaborator.enterStruct_var(clone, nullptr);
  ...
  elaboratorContext->m_elaborator.leaveStruct_var(clone, nullptr);
}

struct_var* struct_var::DeepClone(BaseClass* parent, CloneContext* context) const {
  struct_var* const clone = context->m_serializer->MakeStruct_var();
...
int32_t struct_var::Compare(const BaseClass *other, CompareContext* context) const {
  int32_t r = 0;
