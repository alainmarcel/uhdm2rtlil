...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiUnionTypespec; }

  virtual union_typespec* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmunion_typespec; }

protected:
  void DeepCopy(union_typespec* clone, BaseClass* parent, CloneContext* context) const;
