...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiRealTypespec; }

  virtual real_typespec* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmreal_typespec; }

protected:
  void DeepCopy(real_typespec* clone, BaseClass* parent, CloneContext* context) const;
