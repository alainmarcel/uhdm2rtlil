...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiImmediateCover; }

  virtual immediate_cover* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmimmediate_cover; }

protected:
  void DeepCopy(immediate_cover* clone, BaseClass* parent, CloneContext* context) const;
