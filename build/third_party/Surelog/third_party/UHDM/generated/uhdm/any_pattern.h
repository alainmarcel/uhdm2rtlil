...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiAnyPattern; }

  virtual any_pattern* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmany_pattern; }

protected:
  void DeepCopy(any_pattern* clone, BaseClass* parent, CloneContext* context) const;
