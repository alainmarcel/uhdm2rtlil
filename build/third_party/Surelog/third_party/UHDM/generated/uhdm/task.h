...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiTask; }

  virtual task* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmtask; }

protected:
  void DeepCopy(task* clone, BaseClass* parent, CloneContext* context) const;
