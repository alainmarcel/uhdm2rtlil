...
public:
  ...
  virtual net_drivers* DeepClone(BaseClass* parent, CloneContext* context) const override = 0;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const override { return UHDM_OBJECT_TYPE::uhdmnet_drivers; }

protected:
  void DeepCopy(net_drivers* clone, BaseClass* parent, CloneContext* context) const;
