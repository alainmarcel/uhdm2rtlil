...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiWaitFork; }

  virtual wait_fork* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmwait_fork; }

protected:
  void DeepCopy(wait_fork* clone, BaseClass* parent, CloneContext* context) const;
