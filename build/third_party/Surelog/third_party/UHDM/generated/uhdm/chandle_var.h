...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiChandleVar; }

  virtual chandle_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmchandle_var; }

protected:
  void DeepCopy(chandle_var* clone, BaseClass* parent, CloneContext* context) const;
