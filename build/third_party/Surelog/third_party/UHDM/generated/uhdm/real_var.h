...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiRealVar; }

  virtual real_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmreal_var; }

protected:
  void DeepCopy(real_var* clone, BaseClass* parent, CloneContext* context) const;
