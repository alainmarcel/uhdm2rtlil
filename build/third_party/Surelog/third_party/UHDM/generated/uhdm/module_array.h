...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiModuleArray; }

  virtual module_array* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmmodule_array; }

protected:
  void DeepCopy(module_array* clone, BaseClass* parent, CloneContext* context) const;
