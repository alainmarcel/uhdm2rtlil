...
public:
  ...
  bool Net_bits(VectorOfnet_bit* data) {
    net_bits_ = data;
    return true;
  }
  ...
  virtual net* DeepClone(BaseClass* parent, CloneContext* context) const override = 0;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const override { return UHDM_OBJECT_TYPE::uhdmnet; }

protected:
  void DeepCopy(net* clone, BaseClass* parent, CloneContext* context) const;
