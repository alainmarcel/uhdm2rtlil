...
public:
  ...
  bool Expr_indexes(VectorOfexpr* data) {
    expr_indexes_ = data;
    return true;
  }

  virtual uint32_t VpiType() const final { return vpiVarBit; }

  virtual var_bit* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmvar_bit; }

protected:
  void DeepCopy(var_bit* clone, BaseClass* parent, CloneContext* context) const;
