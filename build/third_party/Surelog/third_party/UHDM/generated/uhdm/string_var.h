...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiStringVar; }

  virtual string_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmstring_var; }

protected:
  void DeepCopy(string_var* clone, BaseClass* parent, CloneContext* context) const;
