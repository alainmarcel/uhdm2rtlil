...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiBitVar; }

  virtual bit_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmbit_var; }

protected:
  void DeepCopy(bit_var* clone, BaseClass* parent, CloneContext* context) const;
