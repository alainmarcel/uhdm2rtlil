...
public:
  ...
  virtual atomic_stmt* DeepClone(BaseClass* parent, CloneContext* context) const override = 0;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const override { return UHDM_OBJECT_TYPE::uhdmatomic_stmt; }

protected:
  void DeepCopy(atomic_stmt* clone, BaseClass* parent, CloneContext* context) const;
