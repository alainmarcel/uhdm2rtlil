...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiNamedBegin; }

  virtual named_begin* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmnamed_begin; }

protected:
  void DeepCopy(named_begin* clone, BaseClass* parent, CloneContext* context) const;
