...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiTimeVar; }

  virtual time_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmtime_var; }

protected:
  void DeepCopy(time_var* clone, BaseClass* parent, CloneContext* context) const;
