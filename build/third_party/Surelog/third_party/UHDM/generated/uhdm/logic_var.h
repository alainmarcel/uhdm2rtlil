...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiLogicVar; }

  virtual logic_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmlogic_var; }

protected:
  void DeepCopy(logic_var* clone, BaseClass* parent, CloneContext* context) const;
