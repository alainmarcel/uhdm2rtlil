...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiSpecParam; }

  virtual spec_param* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmspec_param; }

protected:
  void DeepCopy(spec_param* clone, BaseClass* parent, CloneContext* context) const;
