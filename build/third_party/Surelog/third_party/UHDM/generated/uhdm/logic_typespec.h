...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiLogicTypespec; }

  virtual logic_typespec* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmlogic_typespec; }

protected:
  void DeepCopy(logic_typespec* clone, BaseClass* parent, CloneContext* context) const;
