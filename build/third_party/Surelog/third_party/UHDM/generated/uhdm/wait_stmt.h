...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiWait; }

  virtual wait_stmt* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmwait_stmt; }

protected:
  void DeepCopy(wait_stmt* clone, BaseClass* parent, CloneContext* context) const;
