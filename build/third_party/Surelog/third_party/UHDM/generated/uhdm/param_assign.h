...
public:
  ...
  bool Rhs(any* data) {
    if (!expr_typespec_groupGroupCompliant(data)) return false;
    rhs_ = data;
    return true;
  }
  ...
  virtual uint32_t VpiType() const final { return vpiParamAssign; }

  virtual param_assign* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmparam_assign; }

protected:
  void DeepCopy(param_assign* clone, BaseClass* parent, CloneContext* context) const;
