...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiIntegerVar; }

  virtual integer_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdminteger_var; }

protected:
  void DeepCopy(integer_var* clone, BaseClass* parent, CloneContext* context) const;
