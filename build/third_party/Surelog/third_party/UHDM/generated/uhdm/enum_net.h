...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiEnumNet; }

  virtual enum_net* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmenum_net; }

protected:
  void DeepCopy(enum_net* clone, BaseClass* parent, CloneContext* context) const;
