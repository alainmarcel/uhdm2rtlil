...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiSwitch; }

  virtual switch_tran* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmswitch_tran; }

protected:
  void DeepCopy(switch_tran* clone, BaseClass* parent, CloneContext* context) const;
