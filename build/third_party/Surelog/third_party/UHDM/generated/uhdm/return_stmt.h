...
public:
  ...
  uint32_t VpiType() const final { return vpiReturn; }
  ...
  virtual return_stmt* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmreturn_stmt; }

protected:
  void DeepCopy(return_stmt* clone, BaseClass* parent, CloneContext* context) const;
