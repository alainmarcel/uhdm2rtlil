...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiFinal; }

  virtual final_stmt* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmfinal_stmt; }

protected:
  void DeepCopy(final_stmt* clone, BaseClass* parent, CloneContext* context) const;
