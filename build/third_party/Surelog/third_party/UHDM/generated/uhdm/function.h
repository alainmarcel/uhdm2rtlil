...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiFunction; }

  virtual function* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmfunction; }

protected:
  void DeepCopy(function* clone, BaseClass* parent, CloneContext* context) const;
