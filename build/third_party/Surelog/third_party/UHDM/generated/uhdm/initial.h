...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiInitial; }

  virtual initial* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdminitial; }

protected:
  void DeepCopy(initial* clone, BaseClass* parent, CloneContext* context) const;
