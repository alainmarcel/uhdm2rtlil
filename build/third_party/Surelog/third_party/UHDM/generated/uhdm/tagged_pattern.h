...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiTaggedPattern; }

  virtual tagged_pattern* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmtagged_pattern; }

protected:
  void DeepCopy(tagged_pattern* clone, BaseClass* parent, CloneContext* context) const;
