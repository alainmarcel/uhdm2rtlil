...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiGate; }

  virtual gate* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmgate; }

protected:
  void DeepCopy(gate* clone, BaseClass* parent, CloneContext* context) const;
