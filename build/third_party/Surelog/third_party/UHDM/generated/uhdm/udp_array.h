...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiUdpArray; }

  virtual udp_array* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmudp_array; }

protected:
  void DeepCopy(udp_array* clone, BaseClass* parent, CloneContext* context) const;
