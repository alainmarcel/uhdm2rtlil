...
public:
  ...
  virtual disables* DeepClone(BaseClass* parent, CloneContext* context) const override = 0;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const override { return UHDM_OBJECT_TYPE::uhdmdisables; }

protected:
  void DeepCopy(disables* clone, BaseClass* parent, CloneContext* context) const;
