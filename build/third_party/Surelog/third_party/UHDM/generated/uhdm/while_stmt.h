...
public:
  ...
  uint32_t VpiType() const final { return vpiWhile; }
  ...
  virtual while_stmt* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmwhile_stmt; }

protected:
  void DeepCopy(while_stmt* clone, BaseClass* parent, CloneContext* context) const;
