...
public:
  ...
  uint32_t VpiType() const final { return vpiBreak; }

  virtual break_stmt* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmbreak_stmt; }

protected:
  void DeepCopy(break_stmt* clone, BaseClass* parent, CloneContext* context) const;
