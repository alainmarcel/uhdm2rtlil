...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiImmediateAssert; }

  virtual immediate_assert* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmimmediate_assert; }

protected:
  void DeepCopy(immediate_assert* clone, BaseClass* parent, CloneContext* context) const;
