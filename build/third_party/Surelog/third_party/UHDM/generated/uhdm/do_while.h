...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiDoWhile; }

  virtual do_while* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmdo_while; }

protected:
  void DeepCopy(do_while* clone, BaseClass* parent, CloneContext* context) const;
