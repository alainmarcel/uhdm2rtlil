...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiUnionVar; }

  virtual union_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmunion_var; }

protected:
  void DeepCopy(union_var* clone, BaseClass* parent, CloneContext* context) const;
