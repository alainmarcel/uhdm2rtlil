...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiDeassign; }

  virtual deassign* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmdeassign; }

protected:
  void DeepCopy(deassign* clone, BaseClass* parent, CloneContext* context) const;
