...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiByteTypespec; }

  virtual byte_typespec* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmbyte_typespec; }

protected:
  void DeepCopy(byte_typespec* clone, BaseClass* parent, CloneContext* context) const;
