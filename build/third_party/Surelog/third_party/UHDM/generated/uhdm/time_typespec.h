...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiTimeTypespec; }

  virtual time_typespec* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmtime_typespec; }

protected:
  void DeepCopy(time_typespec* clone, BaseClass* parent, CloneContext* context) const;
