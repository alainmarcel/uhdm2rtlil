...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiChandleTypespec; }

  virtual chandle_typespec* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmchandle_typespec; }

protected:
  void DeepCopy(chandle_typespec* clone, BaseClass* parent, CloneContext* context) const;
