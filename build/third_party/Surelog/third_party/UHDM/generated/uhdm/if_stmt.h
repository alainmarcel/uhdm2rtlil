...
public:
  ...
  uint32_t VpiType() const final { return vpiIf; }
  ...
  virtual if_stmt* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmif_stmt; }

protected:
  void DeepCopy(if_stmt* clone, BaseClass* parent, CloneContext* context) const;
