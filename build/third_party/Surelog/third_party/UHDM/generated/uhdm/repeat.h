...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiRepeat; }

  virtual repeat* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmrepeat; }

protected:
  void DeepCopy(repeat* clone, BaseClass* parent, CloneContext* context) const;
