...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiNullStmt; }

  virtual null_stmt* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmnull_stmt; }

protected:
  void DeepCopy(null_stmt* clone, BaseClass* parent, CloneContext* context) const;
