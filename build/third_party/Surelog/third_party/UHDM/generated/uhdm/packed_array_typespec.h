...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiPackedArrayTypespec; }

  virtual packed_array_typespec* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmpacked_array_typespec; }

protected:
  void DeepCopy(packed_array_typespec* clone, BaseClass* parent, CloneContext* context) const;
