...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiIntVar; }

  virtual int_var* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmint_var; }

protected:
  void DeepCopy(int_var* clone, BaseClass* parent, CloneContext* context) const;
