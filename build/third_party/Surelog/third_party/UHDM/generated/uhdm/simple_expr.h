...
public:
  ...
  bool VpiUses(VectorOfany* data) {
    if (!simple_expr_use_groupGroupCompliant(data)) return false;
    vpiUses_ = data;
    return true;
  }

  virtual simple_expr* DeepClone(BaseClass* parent, CloneContext* context) const override = 0;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const override { return UHDM_OBJECT_TYPE::uhdmsimple_expr; }

protected:
  void DeepCopy(simple_expr* clone, BaseClass* parent, CloneContext* context) const;
