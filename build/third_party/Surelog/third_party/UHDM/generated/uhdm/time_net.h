...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiTimeNet; }

  virtual time_net* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmtime_net; }

protected:
  void DeepCopy(time_net* clone, BaseClass* parent, CloneContext* context) const;
