...
#ifndef UHDM_GEN_IF_ELSE_H
#define UHDM_GEN_IF_ELSE_H
...
class gen_if_else final : public gen_stmt {
  UHDM_IMPLEMENT_RTTI(gen_if_else, gen_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: gen_if_else();
  virtual ~gen_if_else() final = default;
  ...
  virtual uint32_t VpiType() const final { return vpiGenIfElse; }

  virtual gen_if_else* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmgen_if_else; }

protected:
  void DeepCopy(gen_if_else* clone, BaseClass* parent, CloneContext* context) const;
