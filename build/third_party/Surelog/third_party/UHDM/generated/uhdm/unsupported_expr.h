...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiUnsupportedExpr; }

  virtual unsupported_expr* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmunsupported_expr; }

protected:
  void DeepCopy(unsupported_expr* clone, BaseClass* parent, CloneContext* context) const;
