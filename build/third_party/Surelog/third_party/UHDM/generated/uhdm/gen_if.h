...
#ifndef UHDM_GEN_IF_H
#define UHDM_GEN_IF_H
...
class gen_if final : public gen_stmt {
  UHDM_IMPLEMENT_RTTI(gen_if, gen_stmt)
public:
  // Implicit constructor used to initialize all members,
  // comment: gen_if();
  virtual ~gen_if() final = default;
  ...
  virtual uint32_t VpiType() const final { return vpiGenIf; }

  virtual gen_if* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmgen_if; }

protected:
  void DeepCopy(gen_if* clone, BaseClass* parent, CloneContext* context) const;
