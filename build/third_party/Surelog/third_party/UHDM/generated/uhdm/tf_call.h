...
public:
  ...
  bool Tf_call_args(VectorOfany* data) {
    if (!tf_call_argsGroupCompliant(data)) return false;
    tf_call_args_ = data;
    return true;
  }
  ...
  virtual tf_call* DeepClone(BaseClass* parent, CloneContext* context) const override = 0;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const override { return UHDM_OBJECT_TYPE::uhdmtf_call; }

protected:
  void DeepCopy(tf_call* clone, BaseClass* parent, CloneContext* context) const;
