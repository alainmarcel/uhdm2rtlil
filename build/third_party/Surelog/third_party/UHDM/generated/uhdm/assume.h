...
public:
  ...
  virtual uint32_t VpiType() const final { return vpiAssume; }

  virtual assume* DeepClone(BaseClass* parent, CloneContext* context) const override;
  ...
  virtual  UHDM_OBJECT_TYPE UhdmType() const final { return UHDM_OBJECT_TYPE::uhdmassume; }

protected:
  void DeepCopy(assume* clone, BaseClass* parent, CloneContext* context) const;
