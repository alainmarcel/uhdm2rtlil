...
public:
  ...
  virtual void enterSequence_arg(SV3_1aParser::Sequence_argContext *ctx) = 0;
  virtual void exitSequence_arg(SV3_1aParser::Sequence_argContext *ctx) = 0;
  ...
  virtual void enterGenerate_begin_end_block(SV3_1aParser::Generate_begin_end_blockContext *ctx) = 0;
  virtual void exitGenerate_begin_end_block(SV3_1aParser::Generate_begin_end_blockContext *ctx) = 0;
  ...
  virtual void enterComma(SV3_1aParser::CommaContext *ctx) = 0;
  virtual void exitComma(SV3_1aParser::CommaContext *ctx) = 0;
  ...
  virtual void enterArgument(SV3_1aParser::ArgumentContext *ctx) = 0;
  virtual void exitArgument(SV3_1aParser::ArgumentContext *ctx) = 0;
  ...
  virtual void enterPart_select_op_colon(SV3_1aParser::Part_select_op_colonContext *ctx) = 0;
  virtual void exitPart_select_op_colon(SV3_1aParser::Part_select_op_colonContext *ctx) = 0;
