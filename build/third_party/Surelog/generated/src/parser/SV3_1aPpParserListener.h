...
public:
  ...
  virtual void enterComment(SV3_1aPpParser::CommentContext *ctx) = 0;
  virtual void exitComment(SV3_1aPpParser::CommentContext *ctx) = 0;

  virtual void enterIntegral_number(SV3_1aPpParser::Integral_numberContext *ctx) = 0;
  virtual void exitIntegral_number(SV3_1aPpParser::Integral_numberContext *ctx) = 0;
  ...
  virtual void enterDefault_trireg_strength_directive(SV3_1aPpParser::Default_trireg_strength_directiveContext *ctx) = 0;
  virtual void exitDefault_trireg_strength_directive(SV3_1aPpParser::Default_trireg_strength_directiveContext *ctx) = 0;
