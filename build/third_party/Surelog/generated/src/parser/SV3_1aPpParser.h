...
public:
  ...
  enum {
    ...
    RuleMacro_actual_args = 7, RuleComment = 8, RuleIntegral_number = 9, 
    RulePound_delay = 10, RulePound_pound_delay = 11, RuleMacro_definition = 12, 
    RuleInclude_directive = 13, RuleLine_directive = 14, RuleDefault_nettype_directive = 15, 
    RuleSv_file_directive = 16, RuleSv_line_directive = 17, RuleTimescale_directive = 18, 
    ...
    RuleResetall_directive = 30, RuleBegin_keywords_directive = 31, RuleEnd_keywords_directive = 32, 
    ...
    RuleNoaccelerate_directive = 55, RuleDefault_trireg_strength_directive = 56, 
  ...
  SV3_1aPpParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~SV3_1aPpParser() override;
  ...
  class Default_trireg_strength_directiveContext;
  ...
  public:
    ...
    Default_trireg_strength_directiveContext *default_trireg_strength_directive();
  ...
  class  Default_trireg_strength_directiveContext : public antlr4::ParserRuleContext {
  public:
    Default_trireg_strength_directiveContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
