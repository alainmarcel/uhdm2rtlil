...
public:
  enum {
    ...
    INCDIR = 29, COMMA = 30, SEMICOLON = 31, COLONCOLON = 32, COLON = 33, 
    ...
    MINUSMINUS = 174, MINUS = 175, STARCOLONCOLONSTAR = 176, STARSTAR = 177, 
    ...
    BACK_TICK = 406, SURELOG_MACRO_NOT_DEFINED = 407, ANY = 408
  };
  ...
  enum {
    ...
    RuleRef_declaration = 100, RuleData_declaration = 101, RuleVariable_impl_declaration = 102, 
    RuleVariable_declaration = 103, RulePackage_import_declaration = 104, 
    RulePackage_import_item = 105, RulePackage_export_declaration = 106, 
    RuleGenvar_declaration = 107, RuleNet_declaration = 108, RuleType_declaration = 109, 
    RuleEnum_keyword = 110, RuleStruct_keyword = 111, RuleUnion_keyword = 112, 
    RuleClass_keyword = 113, RuleInterface_class_keyword = 114, RuleNet_type_declaration = 115, 
    RuleLifetime = 116, RuleCasting_type = 117, RuleData_type = 118, RulePacked_keyword = 119, 
    RuleString_type = 120, RuleString_value = 121, RuleChandle_type = 122, 
    RuleEvent_type = 123, RuleConst_type = 124, RuleVar_type = 125, RuleData_type_or_implicit = 126, 
    RuleImplicit_data_type = 127, RuleEnum_base_type = 128, RuleEnum_name_declaration = 129, 
    RuleClass_scope = 130, RuleClass_type = 131, RuleInteger_type = 132, 
    RuleInteger_atom_type = 133, RuleInteger_vector_type = 134, RuleNon_integer_type = 135, 
    RuleNet_type = 136, RuleNet_port_type = 137, RuleVariable_port_type = 138, 
    RuleVar_data_type = 139, RuleSigning = 140, RuleSimple_type = 141, RuleRandom_qualifier = 142, 
    RuleStruct_union_member = 143, RuleData_type_or_void = 144, RuleStruct_union = 145, 
    RuleTagged_keyword = 146, RuleType_reference = 147, RuleDrive_strength = 148, 
    RuleStrength0 = 149, RuleStrength1 = 150, RuleCharge_strength = 151, 
    RuleDelay3 = 152, RuleDelay2 = 153, RulePound_delay_value = 154, RuleDelay_value = 155, 
    RuleList_of_defparam_assignments = 156, RuleList_of_interface_identifiers = 157, 
    RuleList_of_net_decl_assignments = 158, RuleList_of_param_assignments = 159, 
    RuleList_of_port_identifiers = 160, RuleList_of_specparam_assignments = 161, 
    RuleList_of_tf_variable_identifiers = 162, RuleList_of_type_assignments = 163, 
    RuleList_of_variable_decl_assignments = 164, RuleList_of_variable_identifiers = 165, 
    RuleList_of_variable_port_identifiers = 166, RuleList_of_virtual_interface_decl = 167, 
    RuleDefparam_assignment = 168, RuleNet_decl_assignment = 169, RuleParam_assignment = 170, 
    RuleSpecparam_assignment = 171, RulePulse_control_specparam = 172, RuleVariable_decl_assignment = 173, 
    ...
    RuleQueue_dimension = 180, RuleUnsized_dimension = 181, RuleFunction_data_type = 182, 
    RuleFunction_data_type_or_implicit = 183, RuleFunction_declaration = 184, 
    RuleFunction_body_declaration = 185, RuleFunction_prototype = 186, RuleDpi_import_export = 187, 
    RuleContext_keyword = 188, RuleFunction_name_decl = 189, RuleTask_name_decl = 190, 
    RulePure_keyword = 191, RuleTask_declaration = 192, RuleTask_body_declaration = 193, 
    RuleTf_item_declaration = 194, RuleTf_port_list = 195, RuleTf_port_item = 196, 
    RuleTf_port_direction = 197, RuleTf_port_declaration = 198, RuleTask_prototype = 199, 
    RuleBlock_item_declaration = 200, RuleOverload_declaration = 201, RuleOverload_operator = 202, 
    RuleOverload_proto_formals = 203, RuleVirtual_interface_declaration = 204, 
    RuleModport_item = 205, RuleModport_ports_declaration = 206, RuleModport_simple_ports_declaration = 207, 
    RuleModport_simple_port = 208, RuleModport_hierarchical_ports_declaration = 209, 
    RuleModport_tf_ports_declaration = 210, RuleModport_tf_port = 211, RuleConcurrent_assertion_item = 212, 
    RuleConcurrent_assertion_statement = 213, RuleAssert_property_statement = 214, 
    RuleAssume_property_statement = 215, RuleCover_property_statement = 216, 
    RuleExpect_property_statement = 217, RuleCover_sequence_statement = 218, 
    RuleRestrict_property_statement = 219, RuleProperty_instance = 220, 
    RuleProperty_actual_arg = 221, RuleConcurrent_assertion_item_declaration = 222, 
    RuleAssertion_item_declaration = 223, RuleProperty_declaration = 224, 
    RuleProperty_port_list = 225, RuleProperty_port_item = 226, RuleProperty_lvar_port_direction = 227, 
    RuleProperty_formal_type = 228, RuleProperty_spec = 229, RuleProperty_expr = 230, 
    RuleProperty_case_item = 231, RuleSequence_declaration = 232, RuleSequence_expr = 233, 
    RuleCycle_delay_range = 234, RuleSequence_method_call = 235, RuleSequence_match_item = 236, 
    RuleSequence_port_list = 237, RuleSequence_port_item = 238, RuleSequence_lvar_port_direction = 239, 
    RuleSequence_formal_type = 240, RuleSequence_instance = 241, RuleSequence_arg = 242, 
    RuleSequence_list_of_arguments = 243, RuleSequence_actual_arg = 244, 
    RuleActual_arg_list = 245, RuleActual_arg_expr = 246, RuleBoolean_abbrev = 247, 
    RuleConsecutive_repetition = 248, RuleNon_consecutive_repetition = 249, 
    RuleGoto_repetition = 250, RuleConst_or_range_expression = 251, RuleCycle_delay_const_range_expression = 252, 
    RuleExpression_or_dist = 253, RuleAssertion_variable_declaration = 254, 
    RuleLet_declaration = 255, RuleLet_port_list = 256, RuleLet_port_item = 257, 
    RuleLet_formal_type = 258, RuleCovergroup_declaration = 259, RuleCoverage_spec_or_option = 260, 
    ...
    RuleBins_keyword = 269, RuleRange_list = 270, RuleTrans_list = 271, 
    RuleTrans_set = 272, RuleTrans_range_list = 273, RuleRepeat_range = 274, 
    RuleCover_cross = 275, RuleList_of_cross_items = 276, RuleCross_item = 277, 
    RuleCross_body = 278, RuleCross_body_item = 279, RuleBins_selection_or_option = 280, 
    RuleBins_selection = 281, RuleSelect_expression = 282, RuleSelect_condition = 283, 
    RuleBins_expression = 284, RuleOpen_range_list = 285, RuleGate_instantiation = 286, 
    RuleCmos_switch_instance = 287, RuleEnable_gate_instance = 288, RuleMos_switch_instance = 289, 
    RuleN_input_gate_instance = 290, RuleN_output_gate_instance = 291, RulePass_switch_instance = 292, 
    RulePass_enable_switch_instance = 293, RulePull_gate_instance = 294, 
    RulePulldown_strength = 295, RulePullup_strength = 296, RuleCmos_switchtype = 297, 
    RuleEnable_gatetype = 298, RuleMos_switchtype = 299, RuleN_input_gatetype = 300, 
    RuleN_output_gatetype = 301, RulePass_en_switchtype = 302, RulePass_switchtype = 303, 
    RuleModule_instantiation = 304, RuleParameter_value_assignment = 305, 
    RuleList_of_parameter_assignments = 306, RuleOrdered_parameter_assignment = 307, 
    RuleNamed_parameter_assignment = 308, RuleHierarchical_instance = 309, 
    RuleName_of_instance = 310, RuleList_of_port_connections = 311, RuleOrdered_port_connection = 312, 
    RuleNamed_port_connection = 313, RuleChecker_instantiation = 314, RuleList_of_checker_port_connections = 315, 
    ...
    RuleCase_generate_item = 343, RuleGenerate_begin_end_block = 344, RuleGenerate_item = 345, 
    ...
    RuleFor_step = 434, RuleFor_step_assignment = 435, RuleComma = 436, 
    RuleLoop_variables = 437, RuleSubroutine_call_statement = 438, RuleAssertion_item = 439, 
    RuleDeferred_immediate_assertion_item = 440, RuleProcedural_assertion_statement = 441, 
    RuleImmediate_assertion_statement = 442, RuleSimple_immediate_assertion_statement = 443, 
    RuleSimple_immediate_assert_statement = 444, RuleSimple_immediate_assume_statement = 445, 
    RuleSimple_immediate_cover_statement = 446, RuleDeferred_immediate_assertion_statement = 447, 
    RuleDeferred_immediate_assert_statement = 448, RuleDeferred_immediate_assume_statement = 449, 
    RuleDeferred_immediate_cover_statement = 450, RuleClocking_declaration = 451, 
    RuleClocking_event = 452, RuleClocking_item = 453, RuleDefault_skew = 454, 
    RuleClocking_direction = 455, RuleList_of_clocking_decl_assign = 456, 
    RuleClocking_decl_assign = 457, RuleClocking_skew = 458, RuleEdge_identifier = 459, 
    RuleClocking_drive = 460, RuleCycle_delay = 461, RuleClockvar = 462, 
    RuleClockvar_expression = 463, RuleRandsequence_statement = 464, RuleProduction = 465, 
    RuleRs_rule = 466, RuleRs_production_list = 467, RuleRs_code_block = 468, 
    RuleRs_prod = 469, RuleProduction_item = 470, RuleRs_if_else = 471, 
    RuleRs_repeat = 472, RuleRs_case = 473, RuleRs_case_item = 474, RuleSpecify_block = 475, 
    RuleSpecify_item = 476, RulePulsestyle_declaration = 477, RuleShowcancelled_declaration = 478, 
    RulePath_declaration = 479, RuleSimple_path_declaration = 480, RuleParallel_path_description = 481, 
    RuleFull_path_description = 482, RuleList_of_path_inputs = 483, RuleList_of_path_outputs = 484, 
    RuleSpecify_input_terminal_descriptor = 485, RuleSpecify_output_terminal_descriptor = 486, 
    RulePath_delay_value = 487, RuleList_of_path_delay_expressions = 488, 
    RuleT_path_delay_expression = 489, RuleTrise_path_delay_expression = 490, 
    RuleTfall_path_delay_expression = 491, RuleTz_path_delay_expression = 492, 
    RuleT01_path_delay_expression = 493, RuleT10_path_delay_expression = 494, 
    RuleT0z_path_delay_expression = 495, RuleTz1_path_delay_expression = 496, 
    RuleT1z_path_delay_expression = 497, RuleTz0_path_delay_expression = 498, 
    RuleT0x_path_delay_expression = 499, RuleTx1_path_delay_expression = 500, 
    RuleT1x_path_delay_expression = 501, RuleTx0_path_delay_expression = 502, 
    RuleTxz_path_delay_expression = 503, RuleTzx_path_delay_expression = 504, 
    RulePath_delay_expression = 505, RuleEdge_sensitive_path_declaration = 506, 
    RuleParallel_edge_sensitive_path_description = 507, RuleFull_edge_sensitive_path_description = 508, 
    RuleState_dependent_path_declaration = 509, RuleSystem_timing_check = 510, 
    RuleDollar_setup_timing_check = 511, RuleDollar_hold_timing_check = 512, 
    RuleDollar_setuphold_timing_check = 513, RuleDollar_recovery_timing_check = 514, 
    RuleDollar_removal_timing_check = 515, RuleDollar_recrem_timing_check = 516, 
    RuleDollar_skew_timing_check = 517, RuleDollar_timeskew_timing_check = 518, 
    RuleDollar_fullskew_timing_check = 519, RuleDollar_period_timing_check = 520, 
    RuleDollar_width_timing_check = 521, RuleDollar_nochange_timing_check = 522, 
    RuleDelayed_data = 523, RuleDelayed_reference = 524, RuleEnd_edge_offset = 525, 
    RuleEvent_based_flag = 526, RuleNotifier = 527, RuleReference_event = 528, 
    RuleRemain_active_flag = 529, RuleStamptime_condition = 530, RuleStart_edge_offset = 531, 
    RuleThreshold = 532, RuleTiming_check_limit = 533, RuleTiming_check_event = 534, 
    RuleControlled_timing_check_event = 535, RuleTiming_check_event_control = 536, 
    RuleSpecify_terminal_descriptor = 537, RuleEdge_control_specifier = 538, 
    RuleEdge_descriptor = 539, RuleTiming_check_condition = 540, RuleScalar_timing_check_condition = 541, 
    RuleScalar_constant = 542, RuleConcatenation = 543, RuleConstant_concatenation = 544, 
    RuleArray_member_label = 545, RuleConstant_multiple_concatenation = 546, 
    RuleModule_path_concatenation = 547, RuleModule_path_multiple_concatenation = 548, 
    RuleMultiple_concatenation = 549, RuleStreaming_concatenation = 550, 
    RuleStream_operator = 551, RuleSlice_size = 552, RuleStream_concatenation = 553, 
    RuleStream_expression = 554, RuleArray_range_expression = 555, RuleEmpty_queue = 556, 
    RuleSubroutine_call = 557, RuleArgument = 558, RuleList_of_arguments = 559, 
    RuleMethod_call = 560, RuleMethod_call_body = 561, RuleBuilt_in_method_call = 562, 
    RuleArray_manipulation_call = 563, RuleRandomize_call = 564, RuleMethod_call_root = 565, 
    RuleArray_method_name = 566, RuleUnique_call = 567, RuleAnd_call = 568, 
    RuleOr_call = 569, RuleXor_call = 570, RuleInc_or_dec_expression = 571, 
    RuleConstant_expression = 572, RuleConditional_operator = 573, RuleConstant_mintypmax_expression = 574, 
    RuleConstant_param_expression = 575, RuleParam_expression = 576, RuleConstant_range_expression = 577, 
    RuleConstant_part_select_range = 578, RuleConstant_range = 579, RuleConstant_indexed_range = 580, 
    RuleExpression = 581, RuleValue_range = 582, RuleMintypmax_expression = 583, 
    RuleModule_path_expression = 584, RuleModule_path_mintypmax_expression = 585, 
    RuleRange_expression = 586, RulePart_select_range = 587, RulePart_select_op = 588, 
    RulePart_select_op_colon = 589, RuleIndexed_range = 590, RuleConstant_primary = 591, 
    RuleModule_path_primary = 592, RuleComplex_func_call = 593, RulePrimary = 594, 
    RuleThis_keyword = 595, RuleSuper_keyword = 596, RuleDollar_keyword = 597, 
    RuleDollar_root_keyword = 598, RuleThis_dot_super = 599, RuleNull_keyword = 600, 
    RuleTime_literal = 601, RuleTime_unit = 602, RuleImplicit_class_handle = 603, 
    RuleBit_select = 604, RuleSelect = 605, RuleNonrange_select = 606, RuleConstant_bit_select = 607, 
    RuleConstant_select = 608, RulePrimary_literal = 609, RuleConstant_cast = 610, 
    RuleCast = 611, RuleNet_lvalue = 612, RuleVariable_lvalue = 613, RuleNonrange_variable_lvalue = 614, 
    RuleInc_or_dec_operator = 615, RuleUnary_module_path_operator = 616, 
    RuleBinary_module_path_operator = 617, RuleNumber = 618, RuleUnbased_unsized_literal = 619, 
    RuleAttribute_instance = 620, RuleAttr_spec = 621, RuleAttr_name = 622, 
    RuleHierarchical_identifier = 623, RuleIdentifier = 624, RuleInterface_identifier = 625, 
    RulePackage_scope = 626, RulePs_identifier = 627, RulePs_or_hierarchical_identifier = 628, 
    RulePs_or_hierarchical_array_identifier = 629, RulePs_or_hierarchical_sequence_identifier = 630, 
    RulePs_type_identifier = 631, RuleSystem_task = 632, RuleSystem_task_names = 633, 
    RuleTop_directives = 634, RulePragma_directive = 635, RulePragma_expression = 636, 
    RulePragma_value = 637, RuleTimescale_directive = 638, RuleBegin_keywords_directive = 639, 
    RuleEnd_keywords_directive = 640, RuleUnconnected_drive_directive = 641, 
    RuleNounconnected_drive_directive = 642, RuleDefault_nettype_directive = 643, 
    RuleUselib_directive = 644, RuleCelldefine_directive = 645, RuleEndcelldefine_directive = 646, 
    RuleProtect_directive = 647, RuleEndprotect_directive = 648, RuleProtected_directive = 649, 
    RuleEndprotected_directive = 650, RuleExpand_vectornets_directive = 651, 
    RuleNoexpand_vectornets_directive = 652, RuleAutoexpand_vectornets_directive = 653, 
    RuleDisable_portfaults_directive = 654, RuleEnable_portfaults_directive = 655, 
    RuleNosuppress_faults_directive = 656, RuleSuppress_faults_directive = 657, 
    RuleSigned_directive = 658, RuleUnsigned_directive = 659, RuleRemove_gatename_directive = 660, 
    RuleNoremove_gatenames_directive = 661, RuleRemove_netname_directive = 662, 
    RuleNoremove_netnames_directive = 663, RuleAccelerate_directive = 664, 
    RuleNoaccelerate_directive = 665, RuleDefault_trireg_strenght_directive = 666, 
    RuleDefault_decay_time_directive = 667, RuleDelay_mode_distributed_directive = 668, 
    RuleDelay_mode_path_directive = 669, RuleDelay_mode_unit_directive = 670, 
    RuleDelay_mode_zero_directive = 671, RuleSurelog_macro_not_defined = 672, 
    RuleSlline = 673, RuleConfig_declaration = 674, RuleDesign_statement = 675, 
    RuleConfig_rule_statement = 676, RuleDefault_clause = 677, RuleInst_clause = 678, 
    RuleInst_name = 679, RuleCell_clause = 680, RuleLiblist_clause = 681, 
    RuleUse_clause_config = 682, RuleUse_clause = 683
  };

  explicit SV3_1aParser(antlr4::TokenStream *input);

  SV3_1aParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~SV3_1aParser() override;
  ...
  class Variable_impl_declarationContext;
  ...
  class Part_select_op_colonContext;
  ...
  public:
    ...
    Variable_impl_declarationContext *variable_impl_declaration();
    Const_typeContext *const_type();
    LifetimeContext *lifetime();
    Type_declarationContext *type_declaration();
  ...
  class  Variable_impl_declarationContext : public antlr4::ParserRuleContext {
  public:
    Variable_impl_declarationContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    antlr4::tree::TerminalNode *STARCOLONCOLONSTAR();
    antlr4::tree::TerminalNode *SEMICOLON();
    std::vector<Package_import_itemContext *> package_import_item();
    Package_import_itemContext* package_import_item(size_t i);
    antlr4::tree::TerminalNode *COMMA();
  ...
  class  Sequence_argContext : public antlr4::ParserRuleContext {
  public:
    Sequence_argContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Sequence_actual_argContext *sequence_actual_arg();
  ...
  Sequence_argContext* sequence_arg();
  ...
  public:
    ...
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
    std::vector<Sequence_argContext *> sequence_arg();
    Sequence_argContext* sequence_arg(size_t i);
    std::vector<antlr4::tree::TerminalNode *> DOT();
    antlr4::tree::TerminalNode* DOT(size_t i);
    std::vector<IdentifierContext *> identifier();
    IdentifierContext* identifier(size_t i);
  ...
  public:
    ...
    antlr4::tree::TerminalNode *TRANSITION_OP();
    Specify_output_terminal_descriptorContext *specify_output_terminal_descriptor();
    Part_select_op_colonContext *part_select_op_colon();
    ExpressionContext *expression();
    std::vector<antlr4::tree::TerminalNode *> CLOSE_PARENS();
    antlr4::tree::TerminalNode* CLOSE_PARENS(size_t i);
    Edge_identifierContext *edge_identifier();
  ...
  class  Part_select_op_colonContext : public antlr4::ParserRuleContext {
  public:
    Part_select_op_colonContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *INC_PART_SELECT_OP();
    antlr4::tree::TerminalNode *DEC_PART_SELECT_OP();
    antlr4::tree::TerminalNode *COLON();
