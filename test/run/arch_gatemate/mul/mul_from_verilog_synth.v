...
module mul_unsigned_sync(clk, rst, en, a, b, p);
  ...
  wire [8:0] _074_;
  (* src = "dut.sv:54.24-54.25" *)
  input [5:0] a;
  wire [5:0] a;
  (* src = "dut.sv:58.17-58.22" *)
  wire [5:0] a_reg;
  (* src = "dut.sv:55.24-55.25" *)
  input [2:0] b;
  wire [2:0] b;
  (* src = "dut.sv:59.17-59.22" *)
  wire [2:0] b_reg;
  (* src = "dut.sv:53.16-53.19" *)
  input clk;
  wire clk;
  (* src = "dut.sv:53.26-53.28" *)
  input en;
  wire en;
  (* src = "dut.sv:56.26-56.27" *)
  output [8:0] p;
  wire [8:0] p;
  (* src = "dut.sv:53.21-53.24" *)
  input rst;
  wire rst;
  \$_AND_  _075_ (
    .A(b_reg[0]),
