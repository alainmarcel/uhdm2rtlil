#!/usr/bin/env python3
# Print the dependency-closure .sv file list for a KEYMGR top module, packages
# first (topologically), so read_slang / surelog get exactly what they need.
#
# Search roots: the keymgr-local rtl/keymgr (hw/ip/keymgr/rtl vendored whole) + rtl/pkg (flash_ctrl_pkg, rom_ctrl_pkg), PLUS the shared prim library
...
ROOTS = [f'{HERE}/rtl/keymgr', f'{HERE}/rtl/pkg', f'{KMAC}/rtl/kmac',
