#!/usr/bin/env python3
# Print the dependency-closure .sv file list for a AES top module, packages
# first (topologically), so read_slang / surelog get exactly what they need.
#
# Search roots: the AES-local rtl/aes (hw/ip/aes/rtl vendored whole), PLUS the shared prim library
