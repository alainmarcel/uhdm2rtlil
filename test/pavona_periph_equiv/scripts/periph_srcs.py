...
#
# Search roots: the six small-IP roots rtl/{rom_ctrl,uart,aon_timer,rv_timer,pattgen,sram_ctrl} (hw/ip/<ip>/rtl vendored whole), PLUS the shared prim library
...
ROOTS = [f'{HERE}/rtl/rom_ctrl', f'{HERE}/rtl/uart', f'{HERE}/rtl/aon_timer', f'{HERE}/rtl/rv_timer', f'{HERE}/rtl/pattgen', f'{HERE}/rtl/sram_ctrl', f'{KMAC}/rtl/kmac',
