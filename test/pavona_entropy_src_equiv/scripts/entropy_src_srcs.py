#!/usr/bin/env python3
# Print the dependency-closure .sv file list for a ENTROPY_SRC top module, packages
# first (topologically), so read_slang / surelog get exactly what they need.
#
# Search roots: the entropy_src-local rtl/entropy_src (hw/ip/entropy_src/rtl vendored whole), PLUS the shared prim library
...
ROOTS = [f'{HERE}/rtl/entropy_src', f'{KMAC}/rtl/kmac',
