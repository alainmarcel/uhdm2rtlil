...
module generate_test(clk, rst_n, data_in, operand, mode, result, extra_result);
  ...
  \$_AND_  _01_ (
    .A(rst_n),
    .B(\gen_units[0].unit_result [5]),
    .Y(result[5])
  );
  \$_AND_  _02_ (
    .A(rst_n),
    .B(\gen_units[0].unit_result [4]),
    .Y(result[4])
  );
  \$_AND_  _03_ (
    .A(rst_n),
    .B(\gen_units[0].unit_result [3]),
    .Y(result[3])
  );
  \$_AND_  _04_ (
    .A(rst_n),
    .B(\gen_units[0].unit_result [2]),
    .Y(result[2])
  );
  \$_AND_  _05_ (
    .A(rst_n),
    .B(\gen_units[0].unit_result [1]),
    .Y(result[1])
  );
  \$_AND_  _06_ (
    .A(rst_n),
  ...
  \$_AND_  _07_ (
    .A(rst_n),
    .B(\gen_units[1].unit_result [6]),
    .Y(result[14])
  );
  \$_AND_  _08_ (
    .A(rst_n),
    .B(\gen_units[1].unit_result [5]),
    .Y(result[13])
  );
  \$_AND_  _09_ (
    .A(rst_n),
    .B(\gen_units[1].unit_result [4]),
    .Y(result[12])
  );
  \$_AND_  _10_ (
    .A(rst_n),
    .B(\gen_units[1].unit_result [3]),
    .Y(result[11])
  );
  \$_AND_  _11_ (
    .A(rst_n),
    .B(\gen_units[1].unit_result [2]),
    .Y(result[10])
  );
  \$_AND_  _12_ (
    .A(rst_n),
    .B(\gen_units[1].unit_result [1]),
    .Y(result[9])
  );
  \$_AND_  _13_ (
    .A(rst_n),
    .B(\gen_units[1].unit_result [0]),
    .Y(result[8])
  );
  \$_AND_  _14_ (
    .A(rst_n),
    .B(\gen_units[2].unit_result [6]),
    .Y(result[22])
  );
  \$_AND_  _15_ (
    .A(rst_n),
    .B(\gen_units[2].unit_result [5]),
    .Y(result[21])
  );
  \$_AND_  _16_ (
    .A(rst_n),
    .B(\gen_units[2].unit_result [4]),
    .Y(result[20])
  );
  \$_AND_  _17_ (
    .A(rst_n),
    .B(\gen_units[2].unit_result [3]),
    .Y(result[19])
  );
  \$_AND_  _18_ (
    .A(rst_n),
    .B(\gen_units[2].unit_result [2]),
    .Y(result[18])
  );
  \$_AND_  _19_ (
    .A(rst_n),
    .B(\gen_units[2].unit_result [1]),
    .Y(result[17])
  );
  \$_AND_  _20_ (
    .A(rst_n),
  ...
  \$_AND_  _21_ (
    .A(rst_n),
    .B(\gen_units[3].unit_result [6]),
    .Y(result[30])
  );
  \$_AND_  _22_ (
    .A(rst_n),
    .B(\gen_units[3].unit_result [5]),
    .Y(result[29])
  );
  \$_AND_  _23_ (
    .A(rst_n),
    .B(\gen_units[3].unit_result [4]),
    .Y(result[28])
  );
  \$_AND_  _24_ (
    .A(rst_n),
    .B(\gen_units[3].unit_result [3]),
    .Y(result[27])
  );
  \$_AND_  _25_ (
    .A(rst_n),
    .B(\gen_units[3].unit_result [2]),
    .Y(result[26])
  );
  \$_AND_  _26_ (
    .A(rst_n),
    .B(\gen_units[3].unit_result [1]),
    .Y(result[25])
  );
  \$_AND_  _27_ (
    .A(rst_n),
    .B(\gen_units[3].unit_result [0]),
    .Y(result[24])
  );
  \$_AND_  _28_ (
    .A(rst_n),
    .B(\gen_units[3].unit_result [7]),
    .Y(result[31])
  );
  \$_AND_  _29_ (
    .A(rst_n),
    .B(\gen_units[2].unit_result [7]),
    .Y(result[23])
  );
  \$_AND_  _30_ (
    .A(rst_n),
    .B(\gen_units[0].unit_result [7]),
    .Y(result[7])
  );
  \$_AND_  _31_ (
    .A(rst_n),
    .B(\gen_units[1].unit_result [7]),
    .Y(result[15])
  );
