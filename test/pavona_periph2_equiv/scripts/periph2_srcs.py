...
#
# Search roots: the six small-IP roots rtl/{sysrst_ctrl,i2c,spi_host,adc_ctrl} (hw/ip/<ip>/rtl vendored whole), PLUS the shared prim library
...
ROOTS = [f'{HERE}/rtl/sysrst_ctrl', f'{HERE}/rtl/i2c', f'{HERE}/rtl/spi_host', f'{HERE}/rtl/adc_ctrl', f'{HERE}/rtl/pkg',
