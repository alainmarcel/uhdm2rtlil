...
#
# Search roots: the six small-IP roots rtl/{usbdev,spi_device} (hw/ip/<ip>/rtl vendored whole), PLUS the shared prim library
...
ROOTS = [f'{HERE}/rtl/usbdev', f'{HERE}/rtl/spi_device', f'{HERE}/rtl/pkg', f'{KMAC}/rtl/kmac', f'{KEYMGR}/rtl/keymgr',
