// Flat shim for spi_device_reg_top: flattens the unpacked-array-of-struct window
...
module spi_device_reg_top_flat import tlul_pkg::*; (
  input  logic clk_i,
  input  logic rst_ni,
  input  tl_h2d_t tl_i,
  ...
  output spi_device_reg_pkg::spi_device_reg2hw_t reg2hw,
  input  spi_device_reg_pkg::spi_device_hw2reg_t hw2reg,
