// AUTO-GENERATED per-module equivalence wrapper for hpdcache_fifo_reg_initialized
...
module hpdcache_fifo_reg_initialized_equiv
  import ariane_pkg::*;
#(
...
,
  ...
  parameter type fifo_data_t = logic [7:0]
) (
