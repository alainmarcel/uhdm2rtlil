...
#
# Search roots: the six small-IP roots rtl/{mbx,dma,soc_dbg_ctrl,ascon} (hw/ip/<ip>/rtl vendored whole), PLUS the shared prim library
...
ROOTS = [f'{HERE}/rtl/mbx', f'{HERE}/rtl/dma', f'{HERE}/rtl/soc_dbg_ctrl', f'{HERE}/rtl/ascon', f'{HERE}/rtl/pkg',
