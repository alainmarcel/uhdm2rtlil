...
- **Total Tests**: 1573 (1026 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1527/1573 tests functional), 1 crash, **0 Miter-Formal
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1037 tests in ~40 min); a PR
