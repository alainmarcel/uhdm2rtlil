...
- **Total Tests**: 1418 (873 internal SystemVerilog + 545 upstream Yosys)
- **Success Rate**: 97% (1373/1418 tests functional), 1 crash, **0 Miter-Formal
  escapes** (no UHDM≠Verilog diff slips past `equiv_induct`)
- **Passing**: 921 tests with formal equivalence verified between the UHDM and Verilog frontends
...
> The **internal** SystemVerilog suite alone is **867 tests, 0 crashes, 0 true
