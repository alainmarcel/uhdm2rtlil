...
- **Total Tests**: 1561 (1014 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1515/1561 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1014 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1026 tests in ~40 min); a PR
