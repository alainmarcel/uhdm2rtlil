...
- **Total Tests**: 1568 (1021 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1522/1568 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1021 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1032 tests in ~40 min); a PR
