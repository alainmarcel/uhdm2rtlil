...
- **Total Tests**: 1396 (851 internal SystemVerilog + 545 upstream Yosys)
- **Success Rate**: 97% (1351/1396 tests functional), 1 crash, **0 Miter-Formal
...
- **UHDM-Only Success**: 435 tests verified end-to-end against Verilator (the UHDM frontend handles SystemVerilog the Verilog frontend can't, so formal equivalence isn't possible — see below)
...
> The **internal** SystemVerilog suite alone is **845 tests, 0 crashes, 0 true
