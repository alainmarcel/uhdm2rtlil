...
- **Total Tests**: 1575 (1028 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1529/1575 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1028 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1039 tests in ~40 min); a PR
