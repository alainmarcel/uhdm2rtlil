...
- **Total Tests**: 1414 (869 internal SystemVerilog + 545 upstream Yosys)
- **Success Rate**: 97% (1369/1414 tests functional), 1 crash, **0 Miter-Formal
...
- **UHDM-Only Success**: 448 tests verified end-to-end against Verilator (the UHDM frontend handles SystemVerilog the Verilog frontend can't, so formal equivalence isn't possible — see below)
...
> The **internal** SystemVerilog suite alone is **863 tests, 0 crashes, 0 true
