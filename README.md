...
- **Total Tests**: 1560 (1013 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1514/1560 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1013 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1024 tests in ~40 min); a PR
