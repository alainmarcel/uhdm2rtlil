...
| **[Caliptra](https://github.com/chipsalliance/caliptra-rtl)** | Caliptra root-of-trust SoC: VeeR EL2 core, AXI sub / manager, mailbox, SHA-256/384/512, HMAC, ECC, Ascon, the ML-DSA / ML-KEM post-quantum block and the caliptra_tlul fabric (`test/caliptra_chip/`) | **867** modules / **172** direct instances of `caliptra_top` | `read_uhdm` + `hierarchy -check` **clean** (327k cells, 2:24); read_slang elaborates the same wrapper in 17 s. Required 3 Surelog preprocessor fixes ([#4179](https://github.com/chipsalliance/Surelog/pull/4179)) and 2 frontend fixes; per-instance miters and co-sim are the next step | — (campaign in progress) |
