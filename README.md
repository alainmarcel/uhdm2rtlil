...
- **Total Tests**: 1567 (1020 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1521/1567 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1020 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1031 tests in ~40 min); a PR
