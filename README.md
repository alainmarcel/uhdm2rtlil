...
- **Total Tests**: 1401 (856 internal SystemVerilog + 545 upstream Yosys)
- **Success Rate**: 97% (1356/1401 tests functional), 1 crash, **0 Miter-Formal
...
- **UHDM-Only Success**: 438 tests verified end-to-end against Verilator (the UHDM frontend handles SystemVerilog the Verilog frontend can't, so formal equivalence isn't possible — see below)
...
> The **internal** SystemVerilog suite alone is **850 tests, 0 crashes, 0 true
