...
### Test Suite Status
- **Total Tests**: 200 tests covering comprehensive SystemVerilog features
- **Success Rate**: 100% (200/200 tests functional, 0 known failures)
...
### Current Test Cases (200 total — 173 passing equivalence, 27 UHDM-only, 0 known failures)
...
**Current Status:**
- 200 of 200 tests are passing or working as expected (173 equiv + 27 UHDM-only)
...
The UHDM frontend test suite includes **200 test cases**:
