...
- **Total Tests**: 1574 (1027 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1528/1574 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1027 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1038 tests in ~40 min); a PR
