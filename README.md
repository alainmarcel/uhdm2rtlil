...
- **Total Tests**: 1572 (1025 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1526/1572 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1025 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1036 tests in ~40 min); a PR
