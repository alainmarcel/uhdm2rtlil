...
- **Total Tests**: 1393 (848 internal SystemVerilog + 545 upstream Yosys)
- **Success Rate**: 97% (1348/1393 tests functional), 1 crash, **0 Miter-Formal
...
- **UHDM-Only Success**: 433 tests verified end-to-end against Verilator (the UHDM frontend handles SystemVerilog the Verilog frontend can't, so formal equivalence isn't possible — see below)
...
> The **internal** SystemVerilog suite alone is **842 tests, 0 crashes, 0 true
