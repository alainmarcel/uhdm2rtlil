...
- **Total Tests**: 1413 (868 internal SystemVerilog + 545 upstream Yosys)
- **Success Rate**: 97% (1368/1413 tests functional), 1 crash, **0 Miter-Formal
...
- **UHDM-Only Success**: 447 tests verified end-to-end against Verilator (the UHDM frontend handles SystemVerilog the Verilog frontend can't, so formal equivalence isn't possible — see below)
...
> The **internal** SystemVerilog suite alone is **862 tests, 0 crashes, 0 true
