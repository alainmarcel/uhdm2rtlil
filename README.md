...
- **Total Tests**: 1410 (865 internal SystemVerilog + 545 upstream Yosys)
- **Success Rate**: 97% (1365/1410 tests functional), 1 crash, **0 Miter-Formal
  escapes** (no UHDM≠Verilog diff slips past `equiv_induct`)
- **Passing**: 919 tests with formal equivalence verified between the UHDM and Verilog frontends
- **UHDM-Only Success**: 445 tests verified end-to-end against Verilator (the UHDM frontend handles SystemVerilog the Verilog frontend can't, so formal equivalence isn't possible — see below)
...
> The **internal** SystemVerilog suite alone is **859 tests, 0 crashes, 0 true
