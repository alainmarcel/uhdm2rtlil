...
- **Total Tests**: 1571 (1024 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1525/1571 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1024 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1035 tests in ~40 min); a PR
