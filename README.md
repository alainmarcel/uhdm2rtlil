...
- **Total Tests**: 1408 (863 internal SystemVerilog + 545 upstream Yosys)
- **Success Rate**: 97% (1363/1408 tests functional), 1 crash, **0 Miter-Formal
  escapes** (no UHDM≠Verilog diff slips past `equiv_induct`)
- **Passing**: 918 tests with formal equivalence verified between the UHDM and Verilog frontends
...
> The **internal** SystemVerilog suite alone is **857 tests, 0 crashes, 0 true
