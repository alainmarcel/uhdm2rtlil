...
[![CI](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/ci.yml) [![Regression (sharded)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/regression-sharded.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/regression-sharded.yml) [![Frontend matrix](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/frontend-matrix.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/frontend-matrix.yml)

**Nightly IP sweeps** — one badge per family; each links to its per-module report:

[![ibex](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-ibex.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-ibex.yml) [![rp32](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-rp32.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-rp32.yml) [![opentitan](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-opentitan.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-opentitan.yml) [![pavona](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-pavona.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-pavona.yml) [![cva6](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-cva6.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-cva6.yml) [![caliptra](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-caliptra.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-caliptra.yml) [![external IP](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-ext.yml/badge.svg?branch=main)](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-ext.yml)
...
`cd test && ./run_parallel.sh 6 --no-cva6` (~1068 tests, ~28 min).  A PR lands
only on a clean run.

| | Total | Internal SV | Upstream Yosys |
|---|---|---|---|
| Tests | 1609 | 1095 | 514 |
| Functional | 1562 (97%) | 1060 | 502 |
...
|----|--------|-------|--------|-------|
| **Ibex** | [lowRISC/ibex](https://github.com/lowRISC/ibex) | 2-stage RV32IMC core (+PMP, ICache, lockstep); 28 modules incl. `ibex_top` | **19 / 28 proven**, **20 / 20 co-sim (100%)**, 26 / 28 opt-clean, 0 driver conflicts; whole hierarchy **0 loops, 0 undriven** | [ibex](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-ibex.yml) |
| **rp32 (R5P)** | [jeras/rp32](https://github.com/jeras/rp32) | 32-bit cores + TCB SoCs; 13 modules | **6 / 13 proven**, 3 / 3 co-sim, 9 / 13 opt-clean; 3 modules carry 32 driver conflicts each, which makes their formal column unreliable; both SoCs boot and run a program in functional sim | [rp32](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-rp32.yml) |
| **OpenTitan** (upstream) | [lowRISC/opentitan](https://github.com/lowRISC/opentitan) @ [`f49474bc`](https://github.com/lowRISC/opentitan/commit/f49474bc89c3ce8a99536329a1e16bf22936da37) | [OTBN](https://github.com/lowRISC/opentitan/tree/master/hw/ip/otbn/rtl) 256-bit bignum accelerator; 32 modules, 122 files | **26 / 32 proven**, **28 / 28 co-sim (100%)**, 4 SAT timeouts (256-bit datapaths), 1 differs (`otbn_reg_top`, whose read_slang baseline diverges too), 1 elaboration error; **every elaborating module opt-clean (0 undriven)**.  The three OTBN modules that diverged — `otbn_instruction_fetch`, `otbn_mac_bignum`, `otbn_mac_bignum_fsm` — are now clean | [opentitan](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-opentitan.yml) |
| **Pavona** | [pavona/pavona](https://github.com/pavona/pavona) @ [`61ebeba1`](https://github.com/pavona/pavona/commit/61ebeba10cafca3b0dd43786fa79d26882a5ccf5) | OpenTitan-derived SoC family: hardened Ibex, TL-UL fabric, 27 crypto/peripheral IPs, 2 full chips; 299 module rows + 98 chip instances | **333 / 353 proven**, **335 / 335 co-sim (100%)**, 345 / 347 opt-clean; chips **47 / 47 + 51 / 51** instances proven, full-chip co-sim **PASS** | [pavona](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-pavona.yml) · [per-IP table](docs/pavona_sweep.md) |
| **Ariane CVA6** | [openhwgroup/cva6](https://github.com/openhwgroup/cva6) | 6-stage 64-bit app-class core (`cv64a6_imafdc_sv39`) + HPDcache, FPnew; 142 modules | **97 / 142 proven**, 123 / 124 co-sim, 114 / 136 opt-clean, 0 driver conflicts; full core lowers with **0 inferred latches**, 0 one-sided co-sim divergences | [cva6](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-cva6.yml) |
...
| **External IP** (8 repos) | see table below | Breadth sweep over third-party (System)Verilog *not* covered above — no vendored copy, each repo fetched at a pinned commit (`test/ext_ip/<family>.json`) | **373 / 467 comparable modules proven**.  277 of 744 are **not comparable** and excluded: 7 cannot elaborate standalone with their own default parameters, 267 `read_slang` cannot read, 3 have interface ports.  Of the 94 comparable-but-unproven, **10 are `read_uhdm` read failures** (2 assert crashes, 3 conflicting init values, 5 other) and **14 are miter errors** — counted against us, not excluded.  Deliberately unfiltered — the un-curated tail | [ext](https://github.com/alainmarcel/uhdm2rtlil/actions/workflows/sweep-ext.yml) |
