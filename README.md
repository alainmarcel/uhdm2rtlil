...
- **Total Tests**: 1566 (1019 internal SystemVerilog + 547 upstream Yosys)
- **Success Rate**: 97% (1520/1566 tests functional), 1 crash, **0 Miter-Formal
...
> The **internal** SystemVerilog suite alone is **1019 tests, 0 crashes, 0 true
...
> is `cd test && ./run_parallel.sh 6 --no-cva6` (1030 tests in ~40 min); a PR
